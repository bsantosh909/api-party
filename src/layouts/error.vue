...
button {
  @apply px-4 py-2 bg-gray-200 rounded text-gray-900 cursor-pointer select-none dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-gray-800 hover:bg-gray-300 focus:outline-none;
}
</style>
